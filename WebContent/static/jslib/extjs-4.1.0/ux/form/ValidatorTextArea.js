 ...
 * 
 * @author JJF
 * @Date Nov 27 2012 使用方式: Ext.create('Ext.ux.form.ValidatorTextArea', {
 *      							 controllerPath : eastcom.baseURL+
 *       									'/sysmng/security/deptNameExsistCheck', 
 *       							 typeFlag : 'nameCn',
 *       							 errorMsg : '中文名已存在，请重新输入！' })
 */
Ext.define('Ext.ux.form.ValidatorTextArea', {
	extend : 'Ext.form.field.TextArea',
	alias : 'widget.validatortextarea',
