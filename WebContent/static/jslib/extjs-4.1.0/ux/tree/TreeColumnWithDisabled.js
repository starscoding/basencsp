...
Ext.define('Ext.ux.tree.TreeColumnWithDisabled', {
	...
	treeRenderer : function(value, metaData, record, rowIdx, colIdx, store,
		...
		var me = this, buf = [], format = Ext.String.format, depth = record
				.getDepth(), treePrefix = me.treePrefix, elbowPrefix = me.elbowPrefix, expanderCls = me.expanderCls, imgText = me.imgText, checkboxText = me.checkboxText, checkboxDisabledText = me.checkboxDisabledText, formattedValue = me.origRenderer
				...
				if (record.getDepth() === depth) {
					...
					if (record.isLast()) {
						if (record.isExpandable()) {
							...
							buf.unshift(format(imgText, (elbowPrefix + 'end'),
									blank));
						}
					...
					if (record.isLast() || record.getDepth() === 0) {
						buf.unshift(format(imgText, (elbowPrefix + 'empty'),
								blank));
