...
Ext.define('Ext.chooser.InfoPanel', {
    ...
    tpl: [
        '<div class="details">',
            '<tpl for=".">',
                    (!Ext.isIE6? '<img src="../../../../static/images/common/appicons/{thumb}" />' : 
                    '<div style="width:74px;height:74px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'../../../../static/images/common/appicons/{thumb}\')"></div>'),
