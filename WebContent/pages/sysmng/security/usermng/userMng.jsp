...
<html>
	<head>
		...
		<title><fmt:message key="pt.userMng"/></title>
		...
		<script src="${ctx}/scripts/sysmng/security/usermng/userMng.js" type="text/javascript"></script>
		<script type="text/javascript" src="${jslib}/My97DatePicker/WdatePicker.js"></script>
  		...
  		<script type="text/javascript">
  			Ext.onReady(function(){
  				...
  				eastcom.modules.userMng.initComponent();
  			});
  		</script>
	<body>	
	</body>
