...
<html>
	<head>
		...
		<title><fmt:message key="monitor.mapping"/></title>
		...
		<script src="${ctx}/scripts/sysmonitor/sysMonitorMapping.js" type="text/javascript"></script>
		...
		<link rel="stylesheet" type="text/css" href="${jslib}/extjs-4.2.1/ux/DataView/data-view.css">
  		...
  		<script type="text/javascript">
  			Ext.onReady(function(){
  				...
  				eastcom.modules.sysMonitorMapping.initComponent();
  			});
  			
  			
  			function monitorHistoryInfo(id,mappingId){
  				eastcom.modules.sysMonitorMapping.initMonitorHistoryInfo(id,mappingId);
  			}
  		</script>
	<body>	
	</body>
